...
<body>
    ...
    <main>
        ...
        <div class="video-container">
            <h4 style="margin-top: 20px;">Sensory Games</h4>
            <iframe
                src="https://drive.google.com/file/d/1GFrW1HIzJQ6c-EQb1sw7nk3NDzvvDg_E/preview"
                title="video player"
                frameborder="0"
        ...
        <section class="requirements">
            <h2 style="margin-top: 70px;">Here is what you need:</h2>
                <ul>
                    <li>Benefits:</li>
                    <li>Stimulates sensory development (sight, sound, touch, and more).
                        Enhances motor skills and cognitive awareness.
                        Builds curiosity and problem-solving abilities.</li>
        ...
        <section class="instructions">
            <h2>Techniques:</h2>
                <ol>
                    <li>Provide toys with different textures, colors, and sounds.
                        Engage in water play or use safe household items like a whisk or sponge for tactile exploration.
                        Play music, encourage dancing, or create sounds with simple instruments like shakers.</li>
        ...
        <section class="lesson-learnt">
            ...
            <!--<h3>1. Chemical Reaction:</h3>-->
                <p>Supervise all sensory activities to ensure safety.
                    Rotate toys and materials to keep experiences fresh and engaging.
                    Adapt games to your baby’s age and developmental stage.</p>
