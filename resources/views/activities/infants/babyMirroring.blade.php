...
<body>
    ...
    <main>
        ...
        <div class="video-container">
            <h4 style="margin-top: 20px;">Baby Mirroring</h4>
            <iframe
                src="https://drive.google.com/file/d/1Dcr_rbZu7Fhlx8nJJQZuUTV0NKDXUZSa/preview"
                title="video player"
                frameborder="0"
        ...
        <section class="requirements">
            <h2 style="margin-top: 70px;">Benefits:</h2>
                <ul>
                    <li>Strengthens emotional bonding by imitating your baby's facial expressions, sounds, and movements.</li>
                    <li>Encourages social and communication skills.</li>
                    <li>Builds self-awareness and connection.</li>
        ...
        <section class="instructions">
            <h2>Techniques:</h2>
                <ol>
                    <li>Copy your baby’s actions, like smiling, cooing, or waving.</li>
                    <li>Maintain eye contact to engage their attention and create a playful interaction.</li>
                    <li>Gradually introduce new expressions or sounds for them to mimic.</li>
        ...
        <section class="lesson-learnt">
            ...
            <!--<h3>1. Chemical Reaction:</h3>-->
                <p>Keep sessions short and fun, following your baby’s cues.
                    Use a mirror to let your baby observe themselves.
                    Incorporate mirroring during calm, alert moments.</p>
