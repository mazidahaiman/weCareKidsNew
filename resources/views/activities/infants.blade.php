    ...
    <main>
        ...
        <section class="activities-grid">
            <div class="activity-item">
                <a href="{{ route('activities.infants.tummy') }}">
                    <img src="{{ asset('img/tummyTime.jpg') }}" alt="Tummy Time">
                    <h3>Tummy Time</h3>
                </a>
            </div>            
            <div class="activity-item">
                <a href="{{ route('activities.infants.babyMassage') }}">
                    <img src="{{ asset('img/babyMassage.jpg') }}" alt="Baby Massage">
                    <h3>Baby Massage</h3>
                </a>
            </div>
            <div class="activity-item">
                <a href="{{ route('activities.infants.sensoryGames') }}">
                    <img src="{{ asset('img/sensory.jpg') }}" alt="Sensory Games">
                    <h3>Sensory Games</h3>
                </a>
            </div>
            <div class="activity-item">
                <a href="{{ route('activities.infants.babyMirroring') }}">
                    <img src="{{ asset('img/mirror.jpg') }}" alt="Baby Mirroring">
                    <h3>Baby Mirroring</h3>
                </a>
            </div>
            <div class="activity-item">
                <a href="{{ route('activities.infants.sitting') }}">
                    <img src="{{ asset('img/sitting.jpg') }}" alt="Baby Sitting">
                    <h3>Baby Sitting</h3>
                </a>
            </div>
