...
<body>
    ...
    <main>
        ...
        <div class="video-container">
            <h4 style="margin-bottom: 20px;">Fun Shapes Matching Game</h4>
            <iframe
                src="https://drive.google.com/file/d/1226DYJQZ2tAQ2KF6H7377bZcY-sBvOdO/preview"
                title="video player"
                frameborder="0"
        ...
        <section class="requirements">
            <h2 style="margin-top: 70px;">Benefits:</h2>
                <ul>
                    ...
                    <li>Shape Recognition: Helps toddlers identify and differentiate between basic shapes (square, circle, triangle, etc.).</li>
                    <li>Fine Motor Skills: Picking up and placing the shapes on the pegs improves hand-eye coordination and dexterity.</li>
                    <li>Sorting and Matching: Encourages cognitive skills as they learn to match shapes to the correct slots.</li>
                    <li>Color Recognition: If colors are included, toddlers can learn to identify and match colors as well.</li>
        ...
        <section class="instructions">
            <h2>Adjustment for age groups:</h2>
                <ol>
                    <li>1 Year Old: Simplify the activity by focusing on fewer shapes (e.g., just circles and squares) and providing more guidance.</li>
                    <li>2 Years Old: Introduce more shapes and encourage independent matching.</li>
                    <li>3 Years Old: Add more complexity by incorporating additional shapes or asking the child to count how many shapes they’ve matched.</li>
        ...
        <section class="lesson-learnt">
            ...
            <!--<h3>1. Chemical Reaction:</h3>-->
                <p>Ensure that all materials are non-toxic and large enough to avoid choking hazards, 
                    as toddlers may still explore objects with their mouths. Supervision is essential for younger toddlers.
                </p>
