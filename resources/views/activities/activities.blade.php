    ...
    <main>
        ...
        <div class="filters">
            <a href="{{ route('activities') }}"
               class="{{ request()->is('activities/activities') ? 'active' : '' }}">All</a>
        ...
        <section class="activities-grid">
            ...
            <div class="activity-item">
                <a href="{{ route('activities.toddlers.funMatching') }}">
                    <img src="{{ asset('img/shapes.png') }}" alt="Shape Matching">
                    <h3>Fun Shape Matching</h3>
                </a>
            </div>
            <div class="activity-item">
            ...
            <div class="activity-item">
                <a href="{{ route('activities.toddlers.eggCarton') }}">
                    <img src="{{ asset('img/carton.jpg') }}" alt="egg carton">
                    <h3>Egg Carton</h3>
                </a>
            </div>
            <div class="activity-item">
